...
const API = "https://bs-api-ssos.onrender.com/lifestyle"
...
const LifestyleContextProvider = ({children}) => {
    ...
    return(
        <LifestyleContext.Provider value={{...state, getSingleNews}}>
            {children}
        </LifestyleContext.Provider>
    )
}

const useLifestyleContext = () => {
    return(
        useContext(LifestyleContext)
    )
}

export {LifestyleContext, LifestyleContextProvider, useLifestyleContext}
